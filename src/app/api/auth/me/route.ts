...
import { getCurrentUserFromAccessToken, issueAuthCookies, REFRESH_TOKEN_COOKIE, rotateRefreshToken, toPublicUser } from "@/lib/auth";
...
export async function GET() {
  try {
    ...
    if (!refreshedUser) return NextResponse.json({ user: null });
